...
namespace MoldovanIoana_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
 public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(MoldovanIoana_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(MoldovanIoana_Lab2Context context,
